...
#include "ui_form_vvod_param_ga.h"

Form_vvod_param_GA::Form_vvod_param_GA(QVector<double> Params, QWidget *parent) : Params_GA(Params),
    QWidget(parent),
    ui(new Ui::Form_vvod_param_GA)
{
    ui->setupUi(this);
...
Form_vvod_param_GA::~Form_vvod_param_GA()
{
    delete ui;
}

void Form_vvod_param_GA::obnovit_params(QVector<double> params)
{
    Params_GA = params;
    ui->label_kol_osobey->setText(QString::number(Params_GA[0]));
    ui->label_max_pokoleniy->setText(QString::number(Params_GA[1]));
...
void Form_vvod_param_GA::on_save_n_quit_clicked()
{
...
void Form_vvod_param_GA::on_sbrosit_parametry_clicked()
{
